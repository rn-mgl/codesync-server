...
description - Full problem statement with examples and explanation. This will be rendered using and edited using tiptap so ensure correct html format is applied and implemented.
