...
export const passwordResetMail = async (email: string, token: string) => {
  ...
  const body = `<!DOCTYPE html>
                ...
                <meta charset="UTF-8" />
                <meta name="viewport" content="width=device-width, initial-scale=1.0" />
                <title>Reset Your CodeSync Password</title>
                ...
                <table role="presentation" width="100%" style="border-collapse:collapse; background-color:#f2f2f2;">
                    ...
                    <td style="padding:40px 20px;">
                        ...
                        <tr>
                            ...
                            <p style="margin:0 0 24px; font-size:16px; line-height:1.7; color:#333333;">
                                We received a request to reset your CodeSync password. If you made this request, click the button below to create a new password.
                            </p>
                            ...
                            <div style="border-top:1px solid #eeeeee; padding-top:28px;">
                                ...
                                If you didn&apos;t ask to reset your password, you can safely ignore this email. Your account remains secure and no changes have been made.
                                </p>
  ...
  if (!data) {
    throw new AppError(
      `An error occurred when sending the password reset mail.`,
      StatusCodes.INTERNAL_SERVER_ERROR,
    );
  }
